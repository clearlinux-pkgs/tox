...
Source0  : https://files.pythonhosted.org/packages/a5/24/2bf6519e581aa1a16efe5718f73973c073492f300ca8aabd5784bf0fdce5/tox-3.23.1.tar.gz
...
%prep
%setup -q -n tox-3.23.1
cd %{_builddir}/tox-3.23.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620316036
...
cp %{_builddir}/tox-3.23.1/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
