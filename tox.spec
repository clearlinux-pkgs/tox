...
Source0  : https://files.pythonhosted.org/packages/57/ec/a4d1fa09ba0beb4f9df786a4232ccf5cfb5cbfb9e786c6041cd66e72be87/tox-3.18.0.tar.gz
...
%prep
%setup -q -n tox-3.18.0
cd %{_builddir}/tox-3.18.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595518531
...
cp %{_builddir}/tox-3.18.0/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
