...
Source0  : https://files.pythonhosted.org/packages/c0/7f/46ff5bae3cef87400719e65de5f6b488699687a2e8a3a02f91c89c775aeb/tox-3.14.6.tar.gz
...
%prep
%setup -q -n tox-3.14.6
cd %{_builddir}/tox-3.14.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585149587
...
cp %{_builddir}/tox-3.14.6/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
