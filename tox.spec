...
Source0  : https://files.pythonhosted.org/packages/d4/9d/3ffe3d5c4fb3e786c571ed5426d342bebaadaaceb24a9fd49fa0657de375/tox-3.19.0.tar.gz
...
%prep
%setup -q -n tox-3.19.0
cd %{_builddir}/tox-3.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597083239
...
cp %{_builddir}/tox-3.19.0/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
