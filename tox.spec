...
Source0  : https://files.pythonhosted.org/packages/fe/66/7206a6c69a5f717fb80cd3a532c0639bc183ad2aa1f23a943ca93b0814bd/tox-3.20.1.tar.gz
...
%prep
%setup -q -n tox-3.20.1
cd %{_builddir}/tox-3.20.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602526509
...
cp %{_builddir}/tox-3.20.1/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
