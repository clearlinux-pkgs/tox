...
Source0  : https://files.pythonhosted.org/packages/13/03/e2d1d99dc55280982445b747e34bd26b8e7e88fcc563f015d653dc8cbab9/tox-3.14.3.tar.gz
...
%prep
%setup -q -n tox-3.14.3
cd %{_builddir}/tox-3.14.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578160515
...
cp %{_builddir}/tox-3.14.3/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
