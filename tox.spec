...
%prep
%setup -q -n tox-3.15.2
cd %{_builddir}/tox-3.15.2
...
cp %{_builddir}/tox-3.15.2/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
