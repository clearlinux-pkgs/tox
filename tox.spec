...
Source0  : https://files.pythonhosted.org/packages/4d/12/cf539738cee565c78280495c944e9fac20bb6c3c382f7cffe4e25bdcabb7/tox-3.17.1.tar.gz
...
%prep
%setup -q -n tox-3.17.1
cd %{_builddir}/tox-3.17.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594867216
...
cp %{_builddir}/tox-3.17.1/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
