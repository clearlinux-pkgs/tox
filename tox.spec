...
Source0  : https://files.pythonhosted.org/packages/d2/78/ad720ade1c6c5b24e407856fb8fc578896ed8e2a603832bb85be3825b551/tox-3.24.4.tar.gz
...
%prep
%setup -q -n tox-3.24.4
cd %{_builddir}/tox-3.24.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631811423
...
cp %{_builddir}/tox-3.24.4/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
