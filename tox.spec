...
Source0  : https://files.pythonhosted.org/packages/87/d1/602b0faa100f327c102cf3cab7c9adc949b64e0a9dc5862045888fb1df38/tox-3.24.1.tar.gz
...
%prep
%setup -q -n tox-3.24.1
cd %{_builddir}/tox-3.24.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627929056
...
cp %{_builddir}/tox-3.24.1/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
