...
Source0  : https://files.pythonhosted.org/packages/2c/bf/7c85d0d956c68a38afb8cc52e7c9dc18f7619f666aa4bc1655afa7247c49/tox-3.24.3.tar.gz
...
%prep
%setup -q -n tox-3.24.3
cd %{_builddir}/tox-3.24.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629743412
...
cp %{_builddir}/tox-3.24.3/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
