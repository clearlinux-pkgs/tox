...
%prep
%setup -q -n tox-3.24.0
cd %{_builddir}/tox-3.24.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626278465
...
cp %{_builddir}/tox-3.24.0/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
