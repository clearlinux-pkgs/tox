...
Source0  : https://files.pythonhosted.org/packages/f1/bc/a3b7fcacf763b23c047cf25e52708855bda873e48022a69a8e74a0387aeb/tox-3.15.0.tar.gz
...
%prep
%setup -q -n tox-3.15.0
cd %{_builddir}/tox-3.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588631683
...
cp %{_builddir}/tox-3.15.0/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
