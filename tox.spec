...
Source0  : https://files.pythonhosted.org/packages/7c/98/e75a77a04b6240c4a48dbd07081966ad07ca8f18402da3d894e01a7141d0/tox-3.21.0.tar.gz
...
%prep
%setup -q -n tox-3.21.0
cd %{_builddir}/tox-3.21.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610131803
...
cp %{_builddir}/tox-3.21.0/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
