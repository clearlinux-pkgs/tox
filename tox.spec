...
Source0  : https://files.pythonhosted.org/packages/af/4f/f571bf4af3363c003a06fda9b964e6c4bb118f394f0f1791bfcea1c7b79a/tox-3.18.1.tar.gz
...
%prep
%setup -q -n tox-3.18.1
cd %{_builddir}/tox-3.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595951004
...
cp %{_builddir}/tox-3.18.1/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
