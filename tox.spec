...
Source0  : https://files.pythonhosted.org/packages/89/9b/df7a0a4ea4fbe43cb82cb196b720c7934d3998e1963ca8ff340450c8958c/tox-3.16.1.tar.gz
...
%prep
%setup -q -n tox-3.16.1
cd %{_builddir}/tox-3.16.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593472359
...
cp %{_builddir}/tox-3.16.1/LICENSE %{buildroot}/usr/share/package-licenses/tox/e7fd7c458df3ba9633d648e0d666e348689f3559
